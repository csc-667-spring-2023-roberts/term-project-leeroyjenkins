...
const createStatus = (id, round, pot, community, player_cards, player_chips, players_alive) =>
    db.any(`INSERT INTO game_status (id, round, pot, community, player_cards, player_chips, players_alive) VALUES ($1, $2, $3, $4, $5, $6, $7);`, [id, round, pot, community, player_cards, player_chips, players_alive])
